...
<?php if($posts != []){ ?>
	<div class="row" id="home-posts-grid">
		<div class="col s12 l12">
			<div id="main-post" class="col s12 l8 main-post-background" style="background: url('<?php echo $posts['post_thumbnail']?>');">
				<div class="mask-img">
			...
			<?php for ($i=1; $i <= 3 ; $i++) { ?>
				<?php if(isset($posts[$i])){ ?>
					<div class="col s12 l4 " id="secundary-post-div-<?php echo $i; ?>">
						<div class="col l6 secundary-post-background" style="background: url('<?php siteURL() ?>/<?php echo $posts[$i]['post_thumbnail']; ?>');">
						</div>
